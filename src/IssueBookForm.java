...
public class IssueBookForm extends JFrame {
	...
	public IssueBookForm() {
		...
		lblBookName.setForeground(Color.CYAN);
		lblBookName.setFont(new Font("Yu Gothic", Font.PLAIN, 14));
		...
		lblStudentId.setFont(new Font("Yu Gothic", Font.PLAIN, 14));
		
		JLabel lblStudentName = new JLabel("Student Name:");
		lblStudentName.setForeground(Color.CYAN);
		lblStudentName.setFont(new Font("Yu Gothic", Font.PLAIN, 14));
		
		JLabel lblStudentContact = new JLabel("Student Contact:");
		lblStudentContact.setForeground(Color.CYAN);
		lblStudentContact.setFont(new Font("Yu Gothic", Font.PLAIN, 14));
		
		JButton btnIssueBook = new JButton("Issue Book");
		btnIssueBook.setVerticalAlignment(SwingConstants.TOP);
		btnIssueBook.setForeground(Color.RED);
		btnIssueBook.setFont(new Font("Yu Gothic", Font.BOLD, 18));
		btnIssueBook.addActionListener(new ActionListener() {
			...
			int i=IssueBookDao.save(bookcallno, studentid, studentname, studentcontact, returndate);
			if(i>0){
		...
		lblReturnDate.setForeground(Color.CYAN);
		lblReturnDate.setFont(new Font("Yu Gothic", Font.PLAIN, 14));
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_contentPane.createSequentialGroup()
							...
							.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING, false)
								...
								.addGroup(Alignment.LEADING, gl_contentPane.createSequentialGroup()
									.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
										.addComponent(lblStudentName, GroupLayout.DEFAULT_SIZE, 108, Short.MAX_VALUE)
										.addComponent(lblStudentContact, GroupLayout.PREFERRED_SIZE, 115, GroupLayout.PREFERRED_SIZE))
						...
						.addGroup(gl_contentPane.createSequentialGroup()
							.addContainerGap()
							.addComponent(lblReturnDate, GroupLayout.PREFERRED_SIZE, 115, GroupLayout.PREFERRED_SIZE)
							.addPreferredGap(ComponentPlacement.RELATED)
		...
		gl_contentPane.setVerticalGroup(
			gl_contentPane.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGap(18)
					.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
						.addComponent(lblReturnDate, GroupLayout.PREFERRED_SIZE, 24, GroupLayout.PREFERRED_SIZE)
