...
public class LibrarianForm extends JFrame {
	...
	public LibrarianForm() {
		...
		lblAddLibrarian.setFont(new Font("Yu Gothic", Font.BOLD, 18));
		
		JLabel lblName = new JLabel("Name:");
		lblName.setFont(new Font("Yu Gothic", Font.PLAIN, 13));
		lblName.setForeground(Color.CYAN);
		
		JLabel lblPassword = new JLabel("Password:");
		lblPassword.setFont(new Font("Yu Gothic", Font.PLAIN, 13));
		lblPassword.setForeground(Color.CYAN);
		
		JLabel lblEmail = new JLabel("Email:");
		lblEmail.setFont(new Font("Yu Gothic", Font.PLAIN, 13));
		lblEmail.setForeground(Color.CYAN);
		
		JLabel lblAddress = new JLabel("Address:");
		lblAddress.setFont(new Font("Yu Gothic", Font.PLAIN, 13));
		lblAddress.setForeground(Color.CYAN);
		
		JLabel lblCity = new JLabel("City:");
		lblCity.setFont(new Font("Yu Gothic", Font.PLAIN, 13));
		lblCity.setForeground(Color.CYAN);
		
		JLabel lblContactNo = new JLabel("Contact No:");
		lblContactNo.setFont(new Font("Yu Gothic", Font.PLAIN, 13));
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_contentPane.createSequentialGroup()
							.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING, false)
								...
								.addComponent(textField_4, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 177, Short.MAX_VALUE)
								.addComponent(textField_3, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 177, Short.MAX_VALUE)
