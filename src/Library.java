...
public class Library extends JFrame {
	...
	public Library() {
		...
		lblLibraryManagement.setFont(new Font("Yu Gothic", Font.BOLD, 20));
		...
		btnAdminLogin.setFont(new Font("Yu Gothic", Font.BOLD, 18));
		
		JButton btnLibrarianLogin = new JButton(" Employee Login");
		btnLibrarianLogin.setForeground(Color.RED);
		btnLibrarianLogin.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				LibrarianLogin.main(new String[]{});
			}
		});
		btnLibrarianLogin.setFont(new Font("Yu Gothic", Font.BOLD, 18));
